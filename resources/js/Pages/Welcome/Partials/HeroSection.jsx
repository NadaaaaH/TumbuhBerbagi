            ...
            <div className="max-w-4xl mx-auto px-6 w-full relative z-20 text-center">
                ...
                >
                    ...
                    <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4 items-center">
                        ...
                        <a
                            href="#faq"
                            className="inline-flex items-center justify-center px-8 py-4 rounded-full bg-[#fef8e7] text-[#d99b00] border border-[#f5e6c4] hover:bg-[#fcc526] hover:text-white hover:border-[#fcc526] font-bold text-base shadow-sm hover:shadow-[0_10px_25px_rgba(252,197,38,0.35)] transition-all duration-300 hover:-translate-y-0.5 active:scale-95"
                        >
