...
import { BookOpen, CheckCircle2, Clock, PlayCircle, Eye, Search, FileText, AlertCircle } from 'lucide-react';
        ...
        <SiswaLayout user={auth.user} header="Latihan Soal UTBK">
            ...
            <div className="space-y-10 pb-16">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-[2rem] border border-slate-100 shadow-2xs">
                    <div>
                        <h2 className="text-xl font-bold text-slate-800 font-sans tracking-tight">Katalog Latihan Soal</h2>
                        <p className="text-slate-450 text-xs mt-1 font-medium">Asah kemampuan UTBK Anda secara terarah dengan paket soal berkualitas.</p>
                    </div>
                ...
                <div className="space-y-4">
                    ...
                    {activePakets.length > 0 ? (
                        ...
                        <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-[0_4px_30px_rgba(0,0,0,0.01)] text-center py-12 flex flex-col items-center justify-center">
                            <Clock size={28} className="text-[#1b5e20]/60 mb-2" />
                ...
                {/* SECTION 2: Riwayat Pengerjaan (Sudah Selesai) */}
                <div className="space-y-4">
                    <div className="flex items-center gap-2.5">
                        <CheckCircle2 size={20} className="text-blue-600" />
                        <h3 className="text-lg font-bold text-slate-800 tracking-tight">Sudah Selesai Dikerjakan</h3>
                    ...
                    {finishedPakets.length > 0 ? (
                        ...
                        <div className="bg-white p-8 rounded-[2rem] border border-slate-100 shadow-[0_4px_30px_rgba(0,0,0,0.01)] text-center py-12 flex flex-col items-center justify-center">
                            ...
                            <p className="text-xs text-slate-400 mt-1 max-w-sm">Selesaikan paket latihan soal pertama Anda untuk memunculkan riwayat pengerjaan di sini.</p>
                        </div>
                    )}
                </div>
